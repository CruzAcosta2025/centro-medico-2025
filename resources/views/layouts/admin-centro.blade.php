...
<body class="bg-gray-100 min-h-screen flex">
    ...
    <aside class="bg-[#003366] text-white w-64 min-h-screen p-5 shadow-lg hidden md:block">
        ...
        <nav>
            <ul class="space-y-3">
                <li><a href="{{ route('admin.centro.dashboard') }}" class="block px-4 py-2 bg-blue-800 rounded-md hover:bg-blue-900 transition">Inicio</a></li>
                <li><a href="{{ route('roles.index') }}" class="block px-4 py-2 bg-blue-800 rounded-md hover:bg-blue-900 transition">Gestión de Roles</a></li>
                <li><a href="{{ route('permisos.index') }}" class="block px-4 py-2 bg-blue-800 rounded-md hover:bg-blue-900 transition">Gestión de Permisos</a></li>
                <li><a href="{{ route('usuarios-centro.index') }}" class="block px-4 py-2 bg-blue-800 rounded-md hover:bg-blue-900 transition">Gestión de Usuarios</a></li>
                <li><a href="{{ route('personal-medico.index') }}" class="block px-4 py-2 bg-blue-800 rounded-md hover:bg-blue-900 transition">Personal Médico</a></li>
                <li><a href="{{ route('especialidad.index') }}" class="block px-4 py-2 bg-blue-800 rounded-md hover:bg-blue-900 transition">Especialidades</a></li>
                <li><a href="{{ route('horarios.index') }}" class="block px-4 py-2 bg-blue-800 rounded-md hover:bg-blue-900 transition">Horarios</a></li>
