            ...
            <form action="{{ route('centros.store') }}" method="POST" class="p-8 space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="nombre" id="nombre" required
                        class="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-700">
                </div>
                ...
                <div class="flex justify-end items-center space-x-3">
                    ...
                    <button type="submit"
                        class="px-5 py-3 bg-blue-900 text-white rounded-md hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-700">
                        Guardar
                    </button>
                </div>
            </form>
