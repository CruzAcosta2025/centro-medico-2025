...
<div class="max-w-3xl mx-auto p-6 w-11/12">
    <div class="bg-white border-2 border-black rounded-lg shadow-lg">
        ...
        <div class="bg-gradient-to-r from-green-500 to-emerald-600 p-5 rounded-t-lg">
            <h2 class="text-white text-xl md:text-2xl font-bold">Añadir Medicamento</h2>
        </div>
            ...
            <form action="{{ route('medicamentos.store', $receta->id_receta) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="instrucciones" id="instrucciones" rows="4"
                        class="w-full p-3 border border-black rounded-md bg-gray-100 focus:ring-2 focus:ring-green-500 resize-y">{{ old('instrucciones') }}</textarea>
                </div>
