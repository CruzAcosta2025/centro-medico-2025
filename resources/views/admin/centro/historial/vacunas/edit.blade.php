...
<div class="max-w-lg mx-auto p-6 w-11/12">
    <div class="bg-white border-2 border-black rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-orange-500 to-red-500 p-4">
            <h2 class="text-white text-xl font-bold">Editar Vacuna</h2>
        </div>
            ...
            <form action="{{ route('vacunas.update', [$vacuna->id_historial, $vacuna->id_vacuna]) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nombre_vacuna" id="nombre_vacuna" value="{{ $vacuna->nombre_vacuna }}" required
                        class="w-full p-3 border border-black rounded-md focus:outline-none focus:ring-2 focus:ring-orange-600 bg-gray-100">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="observaciones" id="observaciones" rows="4"
                        class="w-full p-3 border border-black rounded-md focus:outline-none focus:ring-2 focus:ring-orange-600 bg-gray-100 resize-y">{{ $vacuna->observaciones }}</textarea>
                </div>
                ...
                <div class="flex justify-end items-center mt-6 space-x-4">
                    ...
                    <button type="submit"
                        class="px-5 py-2 bg-red-500 hover:bg-red-600 text-white font-bold rounded-lg border border-black">
                        Actualizar
                    </button>
                </div>
            </form>
