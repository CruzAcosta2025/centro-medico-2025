...
<div class="container">
    <h2 class="text-2xl font-bold mb-4">Agregar Especialidad</h2>
    ...
    <form action="{{ route('especialidad.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nombre_especialidad" id="nombre_especialidad" class="form-input" value="{{ old('nombre_especialidad') }}" required>
        </div>
